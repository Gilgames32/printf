...
A refaktorált szkript már egy nagy erőlelépést jelentett, így jobb híján maradtunk a használatánál. Tudtuk, hogy nem tökéletes, főkét a Photoshop hatalmas overheadje miatt a dokumentumok generálása túl sokáig tartott, és volt, hogy a rendelkezésre álló 8 GB rendelkezésre álló memória sem volt elég a teljes dokumentumhoz. Sajnos az Adobe ExtendScript szkriptnyelv jellegéből adódóan felettébb limitáltak a lehetőségek bármi nemű optimalizálásra. Gyakorta előjöttek olyan esetek is, hogy különböző méretű dokumentumokat szerettünk volna nyomtatni, de a szkript csak egységes cellaméretekkel volt képes dolgozni, külön nyomtatni pedig némi extra papírfelesleggel járt.
