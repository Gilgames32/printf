...
Az előbállítások a \texttt{presets} mappában találhatók, 4 almappára bontva. Minden előbeállítás JSON formátumban értendő. A mappák és a bennük szerplő JSON fájlok kulcsai az alábbiak:
\begin{itemize}
    \item \texttt{document}
    \begin{itemize}
