...
Első lépésben minden elemünket a rövidebbik élére állítjuk, majd valamilyen heurisztika alapján sorba rendezzük őket (pl. magasság szerint csökkenő sorrendbe). Az ábra (\ref{fig:placements}) alapján \href{fig:placements}{(a)}-\href{fig:placements}{(e)} esetekhez rendre prioritásokat rendelünk, ahol \href{fig:placements}{(a)} prioritása a legnagyobb. Meghatározzuk a hátralevő elemeink prioritását, és vesszük a legnagyobb prioritásút. Ha két elemnek megegyezik a prioritása, a sorba rendezésbeli helyük alapján a sorban előrébb lévő elemet vesszük. 

Az így kapott elemet elhelyezzük a téglalapra. A \href{fig:placements}{(d)} esetben nem mindegy sem az elem orientációja, sem hogy hogyan osztjuk tovább a téglalapot.
