...
\begin{itemize}
    ...
    \item A dokumentum legyen vágóasztallal vágható. Ez azt jelenti, hogy a dokumentumot legalább egy helyen el kell tudni vágni vágóasztallal, azaz széltől szélig, egyetlen egyenes vonallal. Az így keletkező tovább osztható szeleteknek is vágóasztallal vághatónak kell lenniük.
...
\begin{itemize}
    ...
    \item A program legyen képes elterjedt nyomtatási formátumú képekkel dolgozni (PNG, JPEG, PDF). 
