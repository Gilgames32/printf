...
A feladat egy olyan szoftver készítése, mely képes adott szélességű és tetszőleges magasságú vászonra a vászonnál kisebb dokumentumokat elhelyezni úgy, hogy minél kevesebb papírfelesleg keletkezzen, azaz a vászon magassága minél kisebb legyen. 
...
\begin{itemize}
    ...
    \item A segédvonalak hossza legyen konfigurálható, azaz hogy a képek sarkától számítva mennyire fussanak be a képek széleinek mentén.
...
\begin{itemize}
    ...
    \item A grafikus felület nyújtson egy kényelmes előnézetet a generált képről, mielőtt az exportálásra kerülne. 
    \item A felhasználói felület legyen intuitív.
    \item A program törekedjen az effektív memóriahasználatra.
    \item A program legyen képes a elterjedt nyomtatási formátumú képekkel dolgozni (PNG, JPG, PDF) 
    ...
    \item A program tartalmazzon néhány elterjedt szabvány méretet és gyakran használt előbeállítást.
\end{itemize}